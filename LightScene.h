...
{
    public:
        LightScene(LightSceneHdl* parent, LightHdl* light_hdl, Datastore* datastore_p, uint32_t task_tmo_m, Datastore::ParameterId brightness_param_id, Datastore::ParameterId color_param_id);
        ~LightScene();
    ...
    protected:
        ...
        LightSceneHdl* m_scene_hdl_p = nullptr;
