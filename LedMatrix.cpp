...
//-----------------------------------------------------------------------------
// define
const uint16_t LED_MATRIX_LUT[LED_MATRIX_NOF_ROW][LED_MATRIX_NOF_COL] PROGMEM = {  // PROGMEM -> store data in flash
...
LedMatrix::LedMatrix()
{
    ...
    m_led_row[0] = new LedRow(m_led_strip, &LED_MATRIX_LUT[0][0], LED_MATRIX_NOF_COL);
    m_led_row[1] = new LedRow(m_led_strip, &LED_MATRIX_LUT[1][0], LED_MATRIX_NOF_COL);
    m_led_row[2] = new LedRow(m_led_strip, &LED_MATRIX_LUT[2][0], LED_MATRIX_NOF_COL);
    m_led_row[3] = new LedRow(m_led_strip_2, &LED_MATRIX_LUT[3][0], LED_MATRIX_NOF_COL);
}
