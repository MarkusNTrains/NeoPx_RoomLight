...
LightScene_OfficeTable::LightScene_OfficeTable(LightHdl* light_hdl, Datastore* datastore_p) : 
    LightScene(light_hdl, datastore_p, LIGHTSCENE_OFFICETABLE_TaskTmoMs, Datastore::ParameterId::SceneOfficeTable_Brightness, Datastore::ParameterId::SceneOfficeTable_Color)
{
}
