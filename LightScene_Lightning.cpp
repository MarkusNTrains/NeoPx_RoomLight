    ...
    switch (this->m_state)
    {
        case LIGHTNING_STATE_Dimming:
            /*if ((this->m_desired_brightness != m_current_brightness) || (this->m_color != COLOR_BLUE))
            {
                ...
                this->m_led_matrix->SetPixelArray(0, LedRow::LED_ROW_LENGTH, 0, (LedRow::LED_ROW_NOF - 1), this->m_color);
            ...
            else*/
            {
                ...
                this->m_light_hdl_p->SetLedArea(0, LedRow::LED_ROW_LENGTH, 0, (LedRow::LED_ROW_NOF - 1), Adafruit_NeoPixel::Color(0, 0, BackgroundBrightness, 0));
